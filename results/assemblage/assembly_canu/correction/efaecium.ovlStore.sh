...
/home/julievm/miniconda3/envs/ngs_efaecium/bin/ovStoreBuild \
 -O  ./efaecium.ovlStore.BUILDING \
 -S ../efaecium.seqStore \
 -C  ./efaecium.ovlStore.config \
 > ./efaecium.ovlStore.err 2>&1 \
&& \
mv ./efaecium.ovlStore.BUILDING ./efaecium.ovlStore
